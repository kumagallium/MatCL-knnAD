...
class Visualization:
    ...
    def show_mcad(self, results, klist):
        ...
        mean_style = dict(markerfacecolor='b',markeredgecolor='b', marker='D',linestyle='--',ms=3,lw=1)
        medi_style = dict(color='r', lw=1)
        boxplot = ax.boxplot(results.values(),showmeans=True,meanprops=mean_style, medianprops=medi_style, flierprops=out_style)
